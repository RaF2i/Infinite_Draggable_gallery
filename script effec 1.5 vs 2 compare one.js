...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function closeExpandedItem() {
    ...
    gsap.delayedCall(0.3, () => {
      ...
      // We don't need originalScale for the expandedItem's target size,
      // as it should always return to a 1x scale at its original position.
      ...
      gsap.to(expandedItem, {
        ...
        x: originalRect.left + itemWidth / 2 - window.innerWidth / 2, // Adjust position for 1x scale
        y: originalRect.top + itemHeight / 2 - window.innerHeight / 2, // Adjust position for 1x scale
        duration: 1,
        ease: "hop",
        ...
        onComplete: () => {
          ...
          if (originalItem) {
            ...
            gsap.to(originalItem, { // Ensure the original item scales back to 1
                scale: 1,
                duration: 0.3,
                ease: "power2.out"
            });
